...
$hero_prod_info = array(
	array(
		'icon' => '/img/hero-prod-icon-1.png',
		'text' => 'Repels Mosquitos AND Ticks, as well as black flies and gnats'
	),
	array(
		'icon' => '/img/hero-prod-icon-2.png',
		'text' => 'Long-Lasting Relief from Insects'
	),
	array(
		'icon' => '/img/hero-prod-icon-3.png',
		'text' => 'Family Safe, Eco-Friendly'
	),
	array(
