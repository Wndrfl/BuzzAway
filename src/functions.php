...
function skellie_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
		...
		//wp_register_script('html5shiv', get_template_directory_uri() . '/vendor/html5shiv/dist/html5shiv.min.js', array(), '1.0.0'); // Conditionizr
        //wp_enqueue_script('html5shiv'); // Enqueue it!

    	//wp_register_script('conditionizr', get_template_directory_uri() . '/vendor/conditionizr/dist/conditionizr.min.js', array(), '1.0.0'); // Conditionizr
        //wp_enqueue_script('conditionizr'); // Enqueue it!

        //wp_register_script('modernizr', get_template_directory_uri() . '/vendor/modernizr/modernizr.js', array(), '1.0.0'); // Modernizr
        //wp_enqueue_script('modernizr'); // Enqueue it!

		// wp_register_script('bootstrap', get_template_directory_uri() . '/vendor/bootstrap/dist/js/bootstrap.min.js', array(), '1.0.0'); // Modernizr
		// wp_enqueue_script('bootstrap'); // Enqueue it!

        wp_register_script('custom', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0'); // Custom scripts
...
function skellie_styles()
{
	...
	//wp_register_style('bootstrap', get_template_directory_uri() . '/vendor/bootstrap/dist/css/bootstrap.min.css', array(), '1.0', 'all');
...
// Custom Excerpts
function skellie_index($length) // Create 20 Word Callback for Index page Excerpts, call using skellie_excerpt('skellie_index');
{
    return 50;
}
...
function skelliecomments($comment, $args, $depth)
{
...
function create_post_type_skellie()
{
    ...
    register_post_type('sample-type', // Register Custom Post Type
        array(
        'labels' => array(
...
function skellie_shortcode_demo_2($atts, $content = null) // Demo Heading H2 shortcode, allows for nesting within above element. Fully expandable.
{
...
function skellie_breadcrumbs() {
    ...
    if (!is_home()) {
        ...
        if (is_category() || is_tax() || is_single()) {
		    ...
		    elseif (is_404()) {echo"<li>We can't find that page (404)</li>";
    ...
    elseif (is_search()) {echo"<li>Search Results"; echo'</li>';}
	else { echo '<li><strong>Resource Center</strong></li>';}
    echo '</ul>';
}
